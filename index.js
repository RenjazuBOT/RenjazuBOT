...
/**
 * REFACTORING CODE by Renjazu (https://github.com/ibnusyawall)
...
const config = {
    BotName: 'Renjazu BOT',
    instagram: 'https://instagram.com/king_renjazu',
    whatsapp: 'wa.me/6283180671136',
...
// client.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log(`${time}: Bot by ig:@king_renjazu`)

client.on('message-status-update', json => {
   const participant = json.participant ? ' (' + json.participant + ')' : ''
   console.log(`[ ${time} ] => bot by ig:@king_renjazu`)
})
